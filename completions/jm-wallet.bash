...
_jm_wallet_completion() {
    ...
    case "$subcmd" in
      ...
      reconstruct-history)
        ...
        ;;
      recover-bonds)
        COMPREPLY=( $(compgen -W "--help --mark-scanned --mnemonic-file -f --prompt-bip39-passphrase --network -n --backend -b --rpc-url --neutrino-url --data-dir --config-file --log-level -l" -- "$cur") )
        ;;
      registry-show)
