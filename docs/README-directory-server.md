...
Use `jm-directory-ctl --help` for installed options, or the generated
[component reference](https://github.com/joinmarket-ng/joinmarket-ng/blob/main/directory_server/README.md).
