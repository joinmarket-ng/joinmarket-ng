...
**EXT** shows all addresses with derivation paths, status labels (`new`, `deposit`, `cj-out`, `non-cj-change`, `reserved`, `used-empty`, `flagged`), individual balances, and mixdepth totals.
