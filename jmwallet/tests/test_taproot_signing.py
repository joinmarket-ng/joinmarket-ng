...
from jmwallet.wallet.signing import sign_p2tr_input, compute_sighash_taproot, SIGHASH_DEFAULT
...
def test_taproot_sighash_and_signing():
    ...
    tx = ParsedTransaction(
        ...
        outputs=[
            TxOutput(value=90000, script=create_p2tr_scriptpubkey(tweaked_pub))
        ],
        locktime=0,
        witnesses=[]
    )
