...
# Channel parameters
CHANNEL_SIZE=15000000      # 15M sats = 0.15 BTC (large enough to cover regtest CoinJoin amounts, below wumbo limit)
PUSH_AMT=7500000           # Push half to Electrum side for balanced liquidity
