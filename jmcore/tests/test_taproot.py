...
def test_taproot_tweak_and_address():
    ...
    internal_pubkey = bytes.fromhex('d6889cb081036e0faefa3a35157ad71086b123b2b144b649798b494c300a961d')
    
    y_parity, tweaked_x_coord = taproot_tweak_pubkey(internal_pubkey)
    
    # Expected tweaked public key (x coord only)
    expected_tweaked_x_coord = bytes.fromhex('53a1f6e454df1aa2776a2814a721372d6258050de330b3c6d10ee8f4e0dda343')
    ...
    assert spk == bytes.fromhex("512053a1f6e454df1aa2776a2814a721372d6258050de330b3c6d10ee8f4e0dda343")
