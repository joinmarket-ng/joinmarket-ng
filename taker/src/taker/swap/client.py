...
class SwapClient:
    ...
    async def _pay_invoice(self, payment_request: str) -> None:
        ...
        try:
            ...
            # MPP improves Lightning privacy (Kappos et al. 2021) by spreading
            # the routing observation over multiple paths. We always request
            # MPP when available; LND falls back to a single path if no
            # multi-path route exists.
